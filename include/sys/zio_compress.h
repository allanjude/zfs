...
#define ZIO_ZSTD_LEVEL_MIN	ZIO_ZSTDLVL_1
	ZIO_ZSTDLVL_2,
	ZIO_ZSTDLVL_3,
#define ZIO_ZSTD_LEVEL_DEFAULT	ZIO_ZSTDLVL_2
	ZIO_ZSTDLVL_4,
	ZIO_ZSTDLVL_5,
	ZIO_ZSTDLVL_6,
	ZIO_ZSTDLVL_7,
...
typedef int zio_getlevel_func_t(void *src, size_t s_len, int32_t *level);
...
extern int zstd_decompress_level(void *src, void *dst, size_t s_len,
    size_t d_len, int32_t *level);
extern int zstd_get_level(void *src, size_t s_len, int32_t *level);
